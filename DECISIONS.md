...
- The status dot's tooltip carries the detail (version, mismatch, or the error); the full alerts stay under the header. Gutters are 16 px on phones and 24 px from 768 px; content width stays 1280 px.
